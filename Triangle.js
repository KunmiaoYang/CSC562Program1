var Triangle = function(p1, p2, p3, material) {
  ...
  var a = p1[0] - p2[0], d = p1[0] - p3[0],
	  b = p1[1] - p2[1], e = p1[1] - p3[1],
	  c = p1[2] - p2[2], f = p1[2] - p3[2];
  var calcT = function(pStart, direction) {
    var g = direction.x, j = p1[0] - pStart.x,
    		h = direction.y, k = p1[1] - pStart.y,
    		i = direction.z, l = p1[2] - pStart.z;
